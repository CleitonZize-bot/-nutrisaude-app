          ...
          <div className="flex flex-col gap-3 border-b border-slate-100 px-4 py-3">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-emerald-500 px-3 py-2 text-xs font-bold text-white active:bg-emerald-600"
              >
                <Share2 size={14} />
                WhatsApp
              </button>
              <button
                type="button"
                onClick={copiarLista}
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-bold text-slate-700 active:bg-slate-100"
              >
                <Copy size={14} />
                Copiar
              </button>
