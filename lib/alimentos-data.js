...
const GRUPOS_SUBSTITUICAO = {
  ...
  gordura_boa: {
    ...
    itens: [
      ...
      { nome: "Óleo de coco",               quantidade: "1 col. sopa", calorias: 90, proteina: 0, carbo: 0, gordura: 10, evitar: ["colesterol"] },
      ...
      { nome: "Semente de girassol",        quantidade: "1 col. sopa", calorias: 55, proteina: 2, carbo: 2, gordura: 5  },
      { nome: "Gergelim",                   quantidade: "1 col. sopa", calorias: 50, proteina: 2, carbo: 2, gordura: 4  },
      { nome: "Pasta de amendoim natural",  quantidade: "1 col. sopa", calorias: 95, proteina: 4, carbo: 3, gordura: 8  }
    ]
  },
  ...
  proteina_leve: {
    ...
    itens: [
      ...
      { nome: "Salmão grelhado",          quantidade: "100g",         calorias: 185, proteina: 25, carbo: 0, gordura: 9  },
      { nome: "Frango ao limão e ervas",  quantidade: "120g",         calorias: 165, proteina: 30, carbo: 1, gordura: 5  },
      { nome: "Omelete de espinafre",     quantidade: "1 porção",     calorias: 160, proteina: 14, carbo: 3, gordura: 10 },
      { nome: "Tilápia no vapor",         quantidade: "150g",         calorias: 165, proteina: 32, carbo: 0, gordura: 4  }
    ]
  },
  ...
  sopa: {
    ...
    itens: [
      ...
      { nome: "Sopa de frango com macarrão",   quantidade: "300ml", calorias: 155, proteina: 14, carbo: 18, gordura: 3 },
      { nome: "Caldo de cebola caramelizada",  quantidade: "300ml", calorias: 90,  proteina: 3,  carbo: 15, gordura: 3 },
      { nome: "Creme de batata doce",          quantidade: "300ml", calorias: 145, proteina: 3,  carbo: 28, gordura: 3 },
      { nome: "Sopa de legumes com quinoa",    quantidade: "300ml", calorias: 150, proteina: 8,  carbo: 22, gordura: 3 },
      { nome: "Caldo de frango com cúrcuma",   quantidade: "300ml", calorias: 120, proteina: 14, carbo: 8,  gordura: 4 }
    ]
  },
  ...
  bebida_lanche: {
    ...
    itens: [
      ...
      { nome: "Suco verde (couve+limão)",   quantidade: "200ml", calorias: 40, proteina: 1, carbo: 8,  gordura: 0, evitar: ["gastrite", "anemia"] },
      ...
      { nome: "Limonada s/ açúcar",         quantidade: "200ml", calorias: 10, proteina: 0, carbo: 3,  gordura: 0, evitar: ["gastrite"] },
      { nome: "Água com gás e limão",       quantidade: "200ml", calorias: 5,  proteina: 0, carbo: 1,  gordura: 0, evitar: ["gastrite"] },
      { nome: "Suco de beterraba c/ cenoura",quantidade:"200ml", calorias: 70, proteina: 1, carbo: 16, gordura: 0 },
      { nome: "Vitamina de frutas vermelhas",quantidade:"200ml", calorias: 90, proteina: 2, carbo: 18, gordura: 1 },
      { nome: "Kefir natural",              quantidade: "150ml", calorias: 60, proteina: 5, carbo: 7,  gordura: 2, evitar: ["lactose"] },
      { nome: "Chá de hibisco gelado s/ açúcar",quantidade:"200ml",calorias:5, proteina:0, carbo:1,  gordura:0 },
      { nome: "Smoothie de abacate c/ cacau",quantidade:"200ml", calorias:110,proteina: 2, carbo: 8,  gordura: 8, evitar: ["diabetes"] }
    ]
  },
  ...
  ceia_sementes: {
    ...
    itens: [
      ...
      { nome: "Granola sem açúcar",      quantidade: "2 col. sopa", calorias: 60, proteina: 2, carbo: 8,  gordura: 2, evitar: ["celiaca"] },
      { nome: "Aveia em flocos",         quantidade: "2 col. sopa", calorias: 55, proteina: 2, carbo: 10, gordura: 1, evitar: ["celiaca"] },
      { nome: "Mel (1 col. chá)",        quantidade: "1 col. chá",  calorias: 20, proteina: 0, carbo: 5,  gordura: 0, evitar: ["diabetes"] },
      { nome: "Castanha-do-pará",        quantidade: "2 unidades",  calorias: 60, proteina: 1, carbo: 1,  gordura: 6 },
      { nome: "Granola sem glúten",      quantidade: "2 col. sopa", calorias: 58, proteina: 2, carbo: 8,  gordura: 2 },
      { nome: "Semente de abóbora torr.",quantidade: "1 col. sopa", calorias: 55, proteina: 3, carbo: 2,  gordura: 4 }
    ]
  },
  ...
  ceia_proteina: {
    ...
    itens: [
      ...
      { nome: "Iogurte de coco sem lactose",  quantidade: "100g",       calorias: 70, proteina: 1,  carbo: 8, gordura: 4 },
      { nome: "Queijo branco light",          quantidade: "30g",        calorias: 55, proteina: 6,  carbo: 1, gordura: 3, evitar: ["lactose", "hipertensao"] },
      { nome: "Pasta de amendoim s/ açúcar",  quantidade: "1 col. sopa",calorias: 95, proteina: 4,  carbo: 3, gordura: 8 }
    ]
  },
  ...
  ceia_complemento: {
    ...
    itens: [
      ...
      { nome: "Chá de valeriana",        quantidade: "200ml", calorias: 2, proteina: 0, carbo: 0, gordura: 0 },
      { nome: "Chá de melissa",          quantidade: "200ml", calorias: 2, proteina: 0, carbo: 0, gordura: 0 },
      { nome: "Água morna com mel",      quantidade: "200ml", calorias: 20, proteina: 0, carbo: 5, gordura: 0, evitar: ["diabetes"] }
    ]
  },

  /* ---- MOLHOS E TEMPEROS ---- */
  molho: {
    nome: "Molhos e temperos saudáveis",
    itens: [
      { nome: "Azeite com limão e ervas",  quantidade: "1 col. sopa", calorias: 45, proteina: 0, carbo: 0, gordura: 5 },
      { nome: "Molho de iogurte c/ ervas", quantidade: "2 col. sopa", calorias: 30, proteina: 2, carbo: 2, gordura: 1, evitar: ["lactose"] },
      { nome: "Vinagrete caseiro",         quantidade: "2 col. sopa", calorias: 20, proteina: 0, carbo: 2, gordura: 1, evitar: ["gastrite"] },
      { nome: "Molho de tahine light",     quantidade: "1 col. sopa", calorias: 50, proteina: 2, carbo: 2, gordura: 4 },
      { nome: "Limão espremido",           quantidade: "suco 1/2 limão",calorias: 5, proteina: 0, carbo: 1, gordura: 0, evitar: ["gastrite"] },
      { nome: "Shoyu light",               quantidade: "1 col. chá",  calorias: 5,  proteina: 1, carbo: 1, gordura: 0, evitar: ["hipertensao"] },
      { nome: "Mostarda dijon s/ sódio",   quantidade: "1 col. chá",  calorias: 5,  proteina: 0, carbo: 1, gordura: 0, evitar: ["gastrite"] },
      { nome: "Azeite com alho",           quantidade: "1 col. sopa", calorias: 50, proteina: 0, carbo: 1, gordura: 5 }
    ]
  },

  /* ---- PROTEÍNA VEGETAL ---- */
  proteina_vegetal: {
    nome: "Proteínas vegetais",
    itens: [
      { nome: "Tofu grelhado",         quantidade: "120g",       calorias: 130, proteina: 14, carbo: 2, gordura: 8  },
      { nome: "Homus caseiro",         quantidade: "4 col. sopa",calorias: 130, proteina: 6,  carbo: 12, gordura: 7, evitar: ["gota"] },
      { nome: "Feijão branco cozido",  quantidade: "3 col. sopa",calorias: 120, proteina: 8,  carbo: 20, gordura: 1 },
      { nome: "Lentilha com legumes",  quantidade: "150g",       calorias: 150, proteina: 10, carbo: 22, gordura: 2, evitar: ["gota"] },
      { nome: "Omelete de espinafre",  quantidade: "1 porção",   calorias: 155, proteina: 13, carbo: 3,  gordura: 10 },
      { nome: "Ovo mexido com couve",  quantidade: "2 ovos",     calorias: 190, proteina: 14, carbo: 4,  gordura: 13 },
      { nome: "Queijo cottage c/ ervas",quantidade: "80g",       calorias: 90,  proteina: 11, carbo: 3,  gordura: 4, evitar: ["lactose"] },
      { nome: "Grão-de-bico assado",   quantidade: "60g seco",   calorias: 120, proteina: 7,  carbo: 18, gordura: 2, evitar: ["gota"] }
    ]
  },

  /* ---- BEBIDAS FUNCIONAIS ---- */
  bebida_funcional: {
    nome: "Bebidas funcionais",
    itens: [
      { nome: "Golden milk (leite c/ cúrcuma)",quantidade:"200ml",calorias:70,proteina:4,carbo:6,gordura:3,evitar:["lactose"] },
      { nome: "Água de coco natural",          quantidade:"200ml",calorias:45,proteina:0,carbo:10,gordura:0 },
      { nome: "Chá verde gelado",              quantidade:"200ml",calorias:2, proteina:0,carbo:0, gordura:0,evitar:["anemia"] },
      { nome: "Suco de beterraba c/ gengibre", quantidade:"200ml",calorias:65,proteina:1,carbo:14,gordura:0,evitar:["gastrite","diabetes"] },
      { nome: "Suco de romã natural",          quantidade:"150ml",calorias:70,proteina:1,carbo:16,gordura:0 },
      { nome: "Vitamina vegetal de amêndoa",   quantidade:"200ml",calorias:60,proteina:2,carbo:6, gordura:4 },
      { nome: "Chá de hibisco c/ gengibre",    quantidade:"200ml",calorias:5, proteina:0,carbo:1, gordura:0,evitar:["gastrite"] },
      { nome: "Kefir de água natural",         quantidade:"200ml",calorias:20,proteina:0,carbo:5, gordura:0 }
    ]
  }
};
...
const REFEICOES_MODELO = {
  cafe: {
    ...
    variacoes: [
      ...
      // Variação 6: Aveia + proteína vegetal + fruta + bebida funcional
      [
        { grupo: "pao_manha",        indiceBase: 6 },
        { grupo: "proteina_vegetal", indiceBase: 4 },
        { grupo: "fruta",            indiceBase: 1 },
        { grupo: "bebida_funcional", indiceBase: 1 }
      ],
      // Variação 7: Torrada integral + ovo + fruta + castanha + bebida funcional
      [
        { grupo: "pao_manha",        indiceBase: 7 },
        { grupo: "ovo",              indiceBase: 0 },
        { grupo: "fruta",            indiceBase: 7 },
        { grupo: "castanha",         indiceBase: 3 },
        { grupo: "bebida_funcional", indiceBase: 4 }
      ]
    ]
  },
  ...
  lancheManha: {
    ...
    variacoes: [
      ...
      // Variação 5: Proteína vegetal + fruta + bebida funcional
      [
        { grupo: "proteina_vegetal", indiceBase: 0 },
        { grupo: "fruta",            indiceBase: 2 },
        { grupo: "bebida_funcional", indiceBase: 1 }
      ],
      // Variação 6: Iogurte + fruta + bebida funcional
      [
        { grupo: "iogurte",          indiceBase: 3 },
        { grupo: "fruta",            indiceBase: 5 },
        { grupo: "bebida_funcional", indiceBase: 5 }
      ]
    ]
  },
  ...
  almoco: {
    ...
    variacoes: [
      ...
      // Variação 8: Arroz + proteína vegetal + salada + legumes + molho
      [
        { grupo: "arroz",              indiceBase: 2 },
        { grupo: "proteina_vegetal",   indiceBase: 0 },
        { grupo: "salada",             indiceBase: 4 },
        { grupo: "legumes",            indiceBase: 11 },
        { grupo: "molho",              indiceBase: 0 },
        { grupo: "gordura_boa",        indiceBase: 0 }
      ],
      // Variação 9: Arroz + feijão + proteína + salada + legumes + molho
      [
        { grupo: "arroz",              indiceBase: 0 },
        { grupo: "feijao",             indiceBase: 0 },
        { grupo: "proteina_principal", indiceBase: 3 },
        { grupo: "salada",             indiceBase: 7 },
        { grupo: "legumes",            indiceBase: 12 },
        { grupo: "molho",              indiceBase: 3 }
      ]
    ]
  },
  ...
  lancheTarde: {
    ...
    variacoes: [
      ...
      // Variação 5: Bebida funcional + castanha + fruta
      [
        { grupo: "bebida_funcional", indiceBase: 2 },
        { grupo: "castanha",         indiceBase: 0 },
        { grupo: "fruta",            indiceBase: 11 }
      ],
      // Variação 6: Proteína vegetal + bebida funcional
      [
        { grupo: "proteina_vegetal", indiceBase: 6 },
        { grupo: "bebida_funcional", indiceBase: 6 },
        { grupo: "fruta",            indiceBase: 6 }
      ]
    ]
  },
  ...
  jantar: {
    ...
    variacoes: [
      ...
      // Variação 7: Proteína vegetal + salada + legumes + molho
      [
        { grupo: "proteina_vegetal", indiceBase: 1 },
        { grupo: "salada",           indiceBase: 2 },
        { grupo: "legumes",          indiceBase: 3 },
        { grupo: "molho",            indiceBase: 1 }
      ],
      // Variação 8: Sopa + proteína leve + bebida funcional
      [
        { grupo: "sopa",             indiceBase: 10 },
        { grupo: "proteina_leve",    indiceBase: 9 },
        { grupo: "bebida_funcional", indiceBase: 7 }
      ]
    ]
  },
  ...
  ceia: {
    ...
    variacoes: [
      ...
      // Variação 5: Proteína de coco + bebida funcional + sementes
      [
        { grupo: "ceia_proteina",    indiceBase: 5 },
        { grupo: "bebida_funcional", indiceBase: 7 },
        { grupo: "ceia_sementes",    indiceBase: 6 }
      ],
      // Variação 6: Complemento relaxante + proteína light + sementes
      [
        { grupo: "ceia_complemento", indiceBase: 2 },
        { grupo: "ceia_proteina",    indiceBase: 4 },
        { grupo: "ceia_sementes",    indiceBase: 7 }
      ]
    ]
  }
};
