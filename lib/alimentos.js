...
export const GRUPOS_SUBSTITUICAO = {
  ...
  pao_manha: {
    ...
    itens: [
      ...
      { nome: "Tapioca",            quantidade: "1 unid. média (80g)", calorias: 135, proteina: 1,  carbo: 34, gordura: 0 },
      ...
      { nome: "Pão de queijo",      quantidade: "2 unid. pequenas",   calorias: 140, proteina: 4,  carbo: 20, gordura: 5 },
      { nome: "Crepioca (ovo + tapioca)", quantidade: "1 unidade",    calorias: 145, proteina: 7,  carbo: 20, gordura: 5 },
  ...
  proteina_manha: {
    ...
    itens: [
      { nome: "Queijo branco",      quantidade: "1 fatia (30g)",      calorias: 70,  proteina: 6,  carbo: 1,  gordura: 4 },
      { nome: "Queijo cottage",     quantidade: "2 col. sopa (40g)",  calorias: 70,  proteina: 7,  carbo: 2,  gordura: 3 },
      { nome: "Ricota",             quantidade: "2 col. sopa (40g)",  calorias: 68,  proteina: 5,  carbo: 2,  gordura: 4 },
      { nome: "Requeijão light",    quantidade: "1 col. sopa (30g)",  calorias: 65,  proteina: 3,  carbo: 2,  gordura: 5 },
      { nome: "Pasta de amendoim",  quantidade: "1 col. sopa (15g)",  calorias: 90,  proteina: 4,  carbo: 3,  gordura: 7 },
      { nome: "Peito de peru",      quantidade: "2 fatias (30g)",     calorias: 40,  proteina: 6,  carbo: 1,  gordura: 1 },
  ...
  fruta: {
    ...
    itens: [
      ...
      { nome: "Banana prata",       quantidade: "1 unidade",          calorias: 85,  proteina: 1,  carbo: 22, gordura: 0 },
      { nome: "Laranja",            quantidade: "1 unidade",          calorias: 75,  proteina: 1,  carbo: 18, gordura: 0 },
      { nome: "Manga",              quantidade: "1 fatia média",      calorias: 80,  proteina: 1,  carbo: 20, gordura: 0 },
      ...
      { nome: "Abacaxi",            quantidade: "2 fatias",           calorias: 75,  proteina: 1,  carbo: 18, gordura: 0 },
  ...
  bebida_cafe: {
    ...
    itens: [
      { nome: "Café sem açúcar",       quantidade: "200ml",           calorias: 5,   proteina: 0,  carbo: 1,  gordura: 0 },
      { nome: "Café com leite desn.",   quantidade: "200ml",          calorias: 50,  proteina: 3,  carbo: 5,  gordura: 2 },
      { nome: "Chá verde",             quantidade: "200ml",           calorias: 2,   proteina: 0,  carbo: 0,  gordura: 0 },
      { nome: "Chá de camomila",        quantidade: "200ml",          calorias: 2,   proteina: 0,  carbo: 0,  gordura: 0 },
      { nome: "Achocolatado light",     quantidade: "200ml",          calorias: 60,  proteina: 3,  carbo: 10, gordura: 1 },
      { nome: "Cappuccino sem açúcar",  quantidade: "200ml",          calorias: 55,  proteina: 3,  carbo: 6,  gordura: 2 }
    ]
  },
  ...
  iogurte: {
    ...
    itens: [
      { nome: "Iogurte natural desnatado",   quantidade: "150g",      calorias: 85,  proteina: 10, carbo: 9,  gordura: 0 },
      { nome: "Iogurte grego light",         quantidade: "120g",      calorias: 85,  proteina: 12, carbo: 6,  gordura: 1 },
      { nome: "Coalhada desnatada",           quantidade: "150g",     calorias: 80,  proteina: 8,  carbo: 10, gordura: 0 },
      { nome: "Iogurte de coco (sem lactose)", quantidade: "150g",   calorias: 90,  proteina: 1,  carbo: 12, gordura: 4 },
      { nome: "Leite desnatado",              quantidade: "200ml",    calorias: 70,  proteina: 7,  carbo: 10, gordura: 0 },
  ...
  arroz: {
    ...
    itens: [
      ...
      { nome: "Arroz branco",        quantidade: "3 col. sopa (90g)",  calorias: 160, proteina: 3,  carbo: 36, gordura: 0 },
      ...
      { nome: "Mandioca cozida",     quantidade: "100g",               calorias: 155, proteina: 1,  carbo: 36, gordura: 0 },
      { nome: "Inhame cozido",       quantidade: "100g",               calorias: 155, proteina: 2,  carbo: 36, gordura: 0 },
      { nome: "Purê de batata",      quantidade: "120g",               calorias: 155, proteina: 3,  carbo: 30, gordura: 3 }
    ]
  },
  ...
  feijao: {
    ...
    itens: [
      ...
      { nome: "Lentilha cozida",     quantidade: "3 col. sopa",       calorias: 95,  proteina: 7,  carbo: 16, gordura: 0 },
      { nome: "Grão-de-bico cozido", quantidade: "3 col. sopa",       calorias: 100, proteina: 6,  carbo: 15, gordura: 2 },
      { nome: "Ervilha cozida",      quantidade: "4 col. sopa",       calorias: 85,  proteina: 5,  carbo: 15, gordura: 0 },
      { nome: "Feijão branco",       quantidade: "2 col. sopa",       calorias: 90,  proteina: 6,  carbo: 16, gordura: 0 },
      { nome: "Edamame",             quantidade: "60g",                calorias: 90,  proteina: 8,  carbo: 7,  gordura: 4 }
    ]
  },
  ...
  proteina_principal: {
    ...
    itens: [
      ...
      { nome: "Patinho bovino grelhado",    quantidade: "100g",       calorias: 180, proteina: 28, carbo: 0,  gordura: 7 },
      ...
      { nome: "Lombo suíno assado",         quantidade: "100g",       calorias: 180, proteina: 27, carbo: 0,  gordura: 8 },
      ...
      { nome: "Sardinha assada",            quantidade: "2 unidades",  calorias: 180, proteina: 24, carbo: 0,  gordura: 9 },
      { nome: "Carne moída magra",          quantidade: "100g",       calorias: 180, proteina: 26, carbo: 0,  gordura: 8 }
    ]
  },
  ...
  salada: {
    ...
    itens: [
      ...
      { nome: "Alface e tomate",          quantidade: "À vontade",    calorias: 25,  proteina: 1,  carbo: 4,  gordura: 0 },
      ...
      { nome: "Repolho com cenoura",       quantidade: "À vontade",   calorias: 25,  proteina: 1,  carbo: 5,  gordura: 0 },
      { nome: "Mix de folhas verdes",      quantidade: "À vontade",   calorias: 20,  proteina: 2,  carbo: 3,  gordura: 0 },
      { nome: "Espinafre com tomate seco", quantidade: "À vontade",   calorias: 30,  proteina: 2,  carbo: 4,  gordura: 1 }
    ]
  },
  ...
  legumes: {
    ...
    itens: [
      ...
      { nome: "Couve-flor no vapor",       quantidade: "100g",        calorias: 40,  proteina: 3,  carbo: 6,  gordura: 0 },
  ...
  proteina_leve: {
    ...
    itens: [
      ...
      { nome: "Sardinha assada",           quantidade: "2 unidades",   calorias: 150, proteina: 20, carbo: 0,  gordura: 8 },
      { nome: "Tofu grelhado",            quantidade: "120g",          calorias: 130, proteina: 14, carbo: 2,  gordura: 8 },
      { nome: "Ricota temperada",         quantidade: "80g",           calorias: 110, proteina: 10, carbo: 3,  gordura: 7 }
    ]
  },
  ...
  sopa: {
    ...
    itens: [
      ...
      { nome: "Caldo de abóbora com gengibre",  quantidade: "300ml",   calorias: 120, proteina: 3,  carbo: 22, gordura: 2 },
      { nome: "Sopa de lentilha",              quantidade: "300ml",    calorias: 160, proteina: 10, carbo: 24, gordura: 2 },
      ...
      { nome: "Sopa de grão-de-bico",          quantidade: "300ml",    calorias: 160, proteina: 8,  carbo: 24, gordura: 3 }
    ]
  },
  ...
  ceia_proteina: {
    ...
    itens: [
      { nome: "Iogurte natural sem açúcar",    quantidade: "100g",    calorias: 60,  proteina: 7,  carbo: 6,  gordura: 0 },
      { nome: "Queijo cottage",                quantidade: "3 col. sopa", calorias: 55, proteina: 7, carbo: 2, gordura: 2 },
      { nome: "Iogurte grego light",           quantidade: "80g",     calorias: 60,  proteina: 8,  carbo: 4,  gordura: 1 },
      { nome: "Leite morno desnatado",         quantidade: "150ml",   calorias: 55,  proteina: 5,  carbo: 8,  gordura: 0 },
  ...
  ceia_sementes: {
    ...
    itens: [
      ...
      { nome: "Mel (1 col. chá)",        quantidade: "1 col. chá",    calorias: 20,  proteina: 0,  carbo: 5,  gordura: 0 }
    ]
  }
};
...
============================================================ */
export function sementeDoDia(diaOffset) {
  const base = new Date();
...
============================================================ */
export function escolherVariacaoDoDia(refeicaoKey, diaOffset) {
...
/* ============================================================
   montarRefeicaoDoDia(refeicaoKey, diaOffset)
   Retorna os itens da refeição para o dia especificado.
   diaOffset = 0 é hoje, 1 é amanhã, etc.
============================================================ */
export function montarRefeicaoDoDia(refeicaoKey, diaOffset) {
  const modelo = REFEICOES_MODELO[refeicaoKey];
  ...
  return variacao.map(slot => {
    ...
    const indice = slot.indiceBase % grupo.itens.length;
    const item = grupo.itens[indice];

    return {
      ...item,
      grupoId: slot.grupo,
      grupoNome: grupo.nome,
      indiceNoGrupo: indice
    };
  });
}
...
============================================================ */
export function obterSubstituicoes(grupoId, indiceAtual) {
