...
const RECEITAS = [
  ...
  },
  {
    ...
    modo: "Ferva 200ml de água, adicione 1 sachê de camomila, deixe em infusão por 5 min. Sirva sem açúcar ou com adoçante.",
    alertas: { gastrite: "Camomila é calmante e anti-inflamatória — ótima para gastrite." },
    calorias: 2, proteina: 0, carbo: 0, gordura: 0
  },

  /* ---- ALMOÇO ---- */
  {
    nome: "Frango ao limão e ervas",
    icone: "🍗",
    refeicao: "almoco",
    ingredientes: ["frango", "limão", "alecrim", "tomilho", "azeite"],
    modo: "Marine o frango com azeite, ervas e limão por 30 min. Grelhe ou asse por 25 min. Sirva com salada verde.",
    alertas: { gastrite: "O limão pode irritar — marine apenas com azeite e ervas, sem limão.", gota: "Frango tem purinas moderadas — porção de 120g é segura." },
    calorias: 165, proteina: 30, carbo: 1, gordura: 5
  },
  {
    nome: "Tilápia grelhada",
    icone: "🐟",
    refeicao: "almoco",
    ingredientes: ["tilápia", "limão", "alho", "azeite", "sal"],
    modo: "Tempere o filé com alho, sal e azeite. Grelhe em frigideira quente 4 min de cada lado. Sirva com arroz integral e salada.",
    alertas: { gota: "Peixe tem purinas moderadas — tilápia é a opção mais segura para gota." },
    calorias: 175, proteina: 32, carbo: 0, gordura: 5
  },
  {
    nome: "Omelete de legumes",
    icone: "🍳",
    refeicao: "almoco",
    ingredientes: ["ovos", "abobrinha", "cenoura", "pimentão", "azeite", "sal"],
    modo: "Refogue os legumes picados por 5 min. Bata 3 ovos, misture os legumes e despeje na frigideira. Cozinhe 3 min tampado.",
    alertas: { colesterol: "Use 2 ovos inteiros + 2 claras para reduzir o colesterol.", gastrite: "Sem pimenta, sem cebola crua — tempere com salsinha e sal." },
    calorias: 220, proteina: 16, carbo: 8, gordura: 14
  },
  ...
  /* ---- JANTAR ---- */
  {
    ...
    icone: "🍜",
    refeicao: "jantar",
    ingredientes: ["frango", "macarrão integral", "cenoura", "salsão", "salsinha", "caldo caseiro"],
    modo: "Cozinhe o frango em água com legumes. Desfie o frango, adicione o macarrão ao caldo e cozinhe por 8 min. Finalize com salsinha.",
    alertas: { hipertensao: "Use caldo caseiro sem sal industrial.", celiaca: "Use macarrão de arroz ou milho no lugar do trigo." },
    calorias: 220, proteina: 20, carbo: 24, gordura: 4
  },
  {
    nome: "Filé de peixe com legumes no vapor",
    icone: "🐟",
    refeicao: "jantar",
    ingredientes: ["peixe branco", "brócolis", "cenoura", "azeite", "ervas", "sal"],
    modo: "Tempere o peixe com ervas e sal. Cozinhe no vapor por 12 min junto aos legumes. Regue com azeite e sirva.",
    alertas: { gota: "Peixe branco (tilápia, merluza) tem baixo teor de purinas — ótima opção." },
    calorias: 200, proteina: 30, carbo: 8, gordura: 5
  },
  ...
  /* ---- LANCHE ---- */
  {
    ...
    icone: "🌟",
    refeicao: "lanche",
    ingredientes: ["leite vegetal", "cúrcuma", "canela", "pimenta-do-reino", "mel"],
    modo: "Aqueça 200ml de bebida vegetal. Adicione 1 col. chá de cúrcuma, canela e pitada de pimenta. Adoce e sirva morno.",
    alertas: { gastrite: "Evite a pimenta-do-reino — use apenas cúrcuma e canela.", diabetes: "Use adoçante no lugar do mel." },
    calorias: 70, proteina: 2, carbo: 8, gordura: 3
  },
  {
    ...
    modo: "Amasse 1 banana, misture 2 col. sopa de aveia, 1 ovo e canela. Frite em frigideira antiaderente sem óleo. Rende 3 panquecas.",
    alertas: { diabetes: "Use banana verde ou 1/2 banana madura para menor impacto glicêmico.", celiaca: "Use aveia sem glúten." },
    calorias: 180, proteina: 7, carbo: 28, gordura: 4
  },
  {
    nome: "Vitamina de frutas vermelhas",
    icone: "🫐",
    refeicao: "lanche",
    ingredientes: ["morango", "amora", "banana", "aveia", "leite vegetal"],
    modo: "Bata 100g de frutas vermelhas, 1/2 banana, 2 col. sopa de aveia e 200ml de bebida vegetal. Sirva gelado.",
    alertas: { diabetes: "Use 1/2 banana e omita o mel — frutas vermelhas têm baixo índice glicêmico.", anemia: "Vitamina C das frutas vermelhas aumenta absorção de ferro da aveia." },
    calorias: 180, proteina: 5, carbo: 34, gordura: 3
  }
];
...
const ALIMENTOS_PREJUDICIAIS = {
  esteatose: [
    ...
    { nome: "frituras",      alerta: "Gordura saturada em excesso agrava a esteatose hepática." },
    { nome: "ultra-processado", alerta: "Alimentos ultraprocessados sobrecarregam o fígado." },
    { nome: "gordura trans", alerta: "Gordura trans é extremamente prejudicial ao fígado." },
    { nome: "creme de leite",alerta: "Alto teor de gordura saturada sobrecarrega o fígado." },
    { nome: "pele de frango",alerta: "A pele do frango concentra gordura saturada — sempre remova." },
  ],
  diabetes: [
    ...
    { nome: "farinha branca",alerta: "Carboidrato refinado com alto índice glicêmico." },
    { nome: "macarrão branco",alerta: "Prefira macarrão integral para menor impacto glicêmico." },
    { nome: "cuscuz",        alerta: "Índice glicêmico moderado-alto — combine sempre com proteína." },
    { nome: "polenta",       alerta: "Fubá tem índice glicêmico moderado — porção pequena com proteína." },
    { nome: "fubá",          alerta: "Índice glicêmico moderado — combine com proteína para equilibrar." },
    { nome: "pure",          alerta: "Purê de batata tem alto índice glicêmico — prefira purê de batata doce." },
  ],
  hipertensao: [
    ...
    { nome: "shoyu",         alerta: "Molho shoyu é muito rico em sódio — use versão light em quantidade mínima." },
    { nome: "conserva",      alerta: "Alimentos em conserva têm alto teor de sódio." },
    { nome: "tempero pronto",alerta: "Temperos industrializados são ricos em sódio — use alho e ervas naturais." },
    { nome: "catchup",       alerta: "Molho industrializado com muito sódio — evite ou use caseiro." },
    { nome: "maionese",      alerta: "Maionese industrializada tem muito sódio — use caseira com azeite." },
  ],
  colesterol: [
    ...
    { nome: "coco ralado",   alerta: "Rico em gordura saturada — consuma com moderação." },
    { nome: "pele de frango",alerta: "A pele do frango concentra gordura saturada — sempre remova." },
    { nome: "nata",          alerta: "Alto teor de gordura saturada, eleva o LDL." },
    { nome: "queijo amarelo",alerta: "Queijos amarelos têm muita gordura saturada — prefira cottage ou branco." },
    { nome: "salame",        alerta: "Embutido rico em gordura saturada e sódio." },
  ],
  gastrite: [
    ...
    { nome: "alho cru",      alerta: "Alho cru pode irritar estômago sensível — prefira refogado ou assado." },
    { nome: "cebola crua",   alerta: "Cebola crua pode causar desconforto — prefira bem cozida." },
    { nome: "gengibre",      alerta: "Gengibre pode irritar estômagos sensíveis — use quantidade pequena." },
    { nome: "vinagre",       alerta: "Ácido acético do vinagre pode irritar a mucosa gástrica." },
    { nome: "mostarda",      alerta: "Condimento ácido que pode irritar o estômago sensível." },
  ],
  lactose: [
  ...
  anemia: [
    ...
    { nome: "espinafre cru", alerta: "Oxalatos do espinafre cru inibem absorção de ferro — prefira refogado com limão." },
    { nome: "soja",          alerta: "Fitatos da soja podem reduzir absorção de ferro — espaçar das refeições com ferro." },
    { nome: "farelo",        alerta: "Fitatos do farelo inibem a absorção de ferro — separe das refeições ricas em ferro." },
  ],
  tireoide: [
    ...
    { nome: "nabo",          alerta: "Vegetal crucífero com goitrogênios — prefira sempre cozido." },
    { nome: "rabanete",      alerta: "Crucífero — prefira cozido para minimizar efeito goitrogênico." },
    { nome: "mostarda",      alerta: "Semente de mostarda tem goitrogênios — use com moderação." },
    { nome: "amendoim",      alerta: "Amendoim pode interferir na absorção do hormônio tireoidiano — evite em excesso." },
  ],
  gota: [
    ...
    { nome: "cerveja",       alerta: "Álcool e purinas da cerveja elevam muito o ácido úrico — evitar completamente." },
    { nome: "camarão",       alerta: "Frutos do mar têm altas purinas — evite em crises de gota." },
    { nome: "fígado",        alerta: "Vísceras têm purinas muito altas — evitar completamente." },
    { nome: "miúdos",        alerta: "Vísceras têm purinas muito altas — evitar completamente." },
    { nome: "extrato de carne", alerta: "Caldos industrializados concentram purinas — evite, use caldo caseiro." },
    { nome: "frutos do mar", alerta: "Frutos do mar em geral têm purinas elevadas — evite em crises." },
    { nome: "ervilha",       alerta: "Tem purinas moderadas — evite em fases agudas de gota." },
    { nome: "cogumelo",      alerta: "Cogumelos têm purinas moderadas — consuma com moderação." },
    { nome: "alcachofra",    alerta: "Tem purinas moderadas — consuma com atenção em crises." },
    { nome: "espinafre",     alerta: "Oxalatos do espinafre podem contribuir para cristais de urato — consuma cozido e com moderação." },
    { nome: "aspargo",       alerta: "Aspargo tem purinas moderadas — evite em fases agudas." },
    { nome: "frango",        alerta: "Frango tem purinas moderadas — prefira peito (120g) e evite em crise aguda." },
    { nome: "álcool",        alerta: "Qualquer bebida alcoólica eleva o ácido úrico — evite completamente." },
    { nome: "refrigerante",  alerta: "Frutose do refrigerante eleva o ácido úrico — evite completamente." },
    { nome: "suco de fruta", alerta: "Suco de fruta concentrado tem frutose que eleva o ácido úrico — prefira fruta in natura." },
  ],
  esteatose: [
    { nome: "açúcar",        alerta: "Frutose em excesso sobrecarrega o fígado." },
    { nome: "fritura",       alerta: "Gordura saturada agrava a esteatose." },
    ...
    { nome: "creme de leite",alerta: "Alto teor de gordura saturada sobrecarrega o fígado." },
    { nome: "pele de frango",alerta: "A pele do frango concentra gordura saturada — sempre remova." },
    { nome: "sorvete",       alerta: "Alto teor de açúcar e gordura saturada — evite ou escolha versão light." },
    { nome: "salgadinho",    alerta: "Ultraprocessado com gordura trans e sódio — evitar." },
    { nome: "chocolate",     alerta: "Prefira chocolate 70%+ cacau em pequena quantidade — evite ao leite." },
    { nome: "pão branco",    alerta: "Carboidrato refinado que se converte em gordura hepática — prefira integral." },
  ]
};
