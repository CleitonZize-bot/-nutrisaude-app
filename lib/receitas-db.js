...
const RECEITAS_DB = {
  ...
  /* ============================================================
     RECEITAS ECONÔMICAS BRASILEIRAS
     Pratos populares acessíveis (R$ 3 a R$ 8 por porção) usando
     só ingredientes que se acha em qualquer mercado de bairro.
  ============================================================ */
  ...
  "Arroz com feijão e ovo": {
    ...
    ingredientes: [
      ...
      "1/2 xíc. feijão carioca cozido",
      "2 ovos",
      "1 col. chá azeite",
      "Alho, sal e cheiro-verde",
    ],
    preparo: [
      "Tempere o arroz com alho refogado em pouco azeite.",
      "Aqueça o feijão com seu próprio caldo e tempere com cheiro-verde.",
      "Frite os ovos em frigideira antiaderente com pouco azeite.",
      "Sirva tudo no prato e finalize com cheiro-verde fresco.",
    ],
    dica: "O clássico arroz-feijão-ovo é completo: carbo, proteína vegetal e animal por menos de R$ 4. Use arroz integral para baixar o índice glicêmico.",
    recomendado: ["anemia"],
    alertas: {
      diabetes: "Prefira arroz integral e meça 4 colheres de arroz, no máximo.",
      hipertensao: "Cuidado com sal — use alho e cheiro-verde para temperar.",
    },
    adaptacoes: {
      diabetes: "Troque o arroz branco por integral (mesmo preço, melhor controle glicêmico).",
      esteatose: "Use só 1 col. chá de azeite total e prefira ovo cozido em vez de frito.",
    },
  },

  "Sopa caseira de legumes da feira": {
    tempo: "30 min", porcao: "2 tigelas",
    ingredientes: [
      "1 batata média",
      "1 cenoura",
    ...
    preparo: [
      ...
      "Refogue cebola e alho em pouco azeite.",
      "Adicione os legumes e cubra com 600ml de água.",
      "Cozinhe 20 min até os legumes ficarem macios.",
      "Bata metade no liquidificador e volte à panela para encorpar.",
      "Finalize com cheiro-verde fresco.",
    ],
    dica: "Sopa que custa R$ 3-4 e rende 2 tigelas. Pode adicionar frango desfiado se tiver. Excelente para esteatose e hipertensão.",
    recomendado: ["esteatose", "colesterol", "hipertensao", "diabetes"],
    alertas: {},
    adaptacoes: {
      anemia: "Adicione um punhado de couve picada nos últimos 5 min — rica em ferro.",
    },
  },
  ...
  "Cuscuz com ovo e tomate": {
    ...
    preparo: [
      "Hidrate o flocão com 3/4 xíc. de água morna e uma pitada de sal por 3 min.",
      "Coloque na cuscuzeira (ou pote furado no vapor) por 8 min.",
      "Refogue cebola e tomate em fogo baixo até virar molho.",
      "Frite ou mexa o ovo na frigideira.",
      "Sirva o cuscuz com o tomate refogado e o ovo por cima.",
    ],
    dica: "Café da manhã ou jantar nordestino que custa menos de R$ 3. Mata a fome, dá energia e tem proteína.",
    recomendado: ["anemia"],
    alertas: {
      hipertensao: "Vá leve no sal — o flocão já tem um pouco.",
    },
    adaptacoes: {},
  },
  ...
  "Macarrão integral com molho caseiro": {
    ...
    preparo: [
      "Cozinhe o macarrão em água com pouco sal por 8-10 min (al dente).",
      "Refogue cebola e alho em pouco azeite.",
      "Adicione os tomates picados sem pele e cozinhe 10 min até desmanchar.",
      "Tempere com orégano ou manjericão.",
      "Misture com o macarrão e sirva.",
    ],
    dica: "Molho de tomate caseiro é R$ 1,50 e infinitamente mais saudável que o de saquinho (que tem açúcar e sódio). Ingrediente principal: tempo, não dinheiro.",
    recomendado: ["esteatose", "colesterol"],
    alertas: {
      diabetes: "Meça 80g cru de macarrão e combine com salada para diminuir o pico de glicemia.",
    },
    adaptacoes: {
      diabetes: "Adicione brócolis ou abobrinha cozida ao molho — fibras que reduzem o impacto glicêmico.",
    },
  },
  ...
  "Vitamina de banana com aveia": {
    ...
    dica: "Café da manhã rápido por menos de R$ 2. A canela ajuda no controle glicêmico. Ideal para quem corre de manhã.",
    recomendado: ["diabetes", "colesterol", "esteatose"],
    alertas: {
      diabetes: "Use 1/2 banana se a glicemia estiver descontrolada.",
    },
    adaptacoes: {},
  },
  ...
  "PF caseiro saudável": {
    tempo: "25 min", porcao: "1 prato",
    ingredientes: [
      "120g sobrecoxa de frango sem pele",
      "4 col. sopa arroz cozido",
      "3 col. sopa feijão cozido",
      "Salada de alface, tomate e cenoura ralada",
      "Alho, cebola, sal, cheiro-verde",
    ],
    preparo: [
      "Tempere o frango com alho, sal (pouco) e limão.",
      "Grelhe em frigideira antiaderente, 6 min de cada lado.",
      "Sirva com arroz, feijão e salada à vontade.",
      "Finalize com cheiro-verde.",
    ],
    dica: "Prato feito tradicional, custa R$ 6-8 e tem tudo: proteína magra, carbo, leguminosa e vegetais frescos.",
    recomendado: ["anemia", "diabetes", "colesterol"],
    alertas: {
      hipertensao: "Tempere com alho, cebola e ervas — pouco sal.",
    },
    adaptacoes: {},
  },

  "Omelete de espinafre com alho": {
    tempo: "10 min", porcao: "1 omelete",
    ingredientes: [
      "2 ovos",
      "1 punhado de espinafre fresco (ou couve)",
      "2 dentes de alho",
      "1 col. chá azeite",
      "Sal a gosto",
    ],
    preparo: [
      "Refogue alho e espinafre rapidamente em pouco azeite.",
      "Bata os ovos com uma pitada de sal.",
      "Despeje sobre o espinafre na frigideira.",
      "Cozinhe em fogo baixo por 4-5 min, dobre e sirva.",
    ],
    dica: "R$ 3 por omelete. Combinação ferro (espinafre) + proteína completa (ovo) = ideal para anemia.",
    recomendado: ["anemia", "diabetes", "colesterol", "esteatose"],
    alertas: {},
    adaptacoes: {},
  },
  ...
  "Frango refogado com legumes": {
    tempo: "20 min", porcao: "2 porções",
    ingredientes: [
      "200g peito de frango em cubos",
      "1 cenoura em cubos",
      "1 abobrinha",
      "1/2 pimentão",
      "1/2 cebola",
    ...
    preparo: [
      ...
      "Refogue em fogo alto até dourar (5 min).",
      "Adicione cebola, pimentão e cenoura — refogue 5 min.",
      "Acrescente abobrinha por último, pois cozinha rápido.",
      "Tampe e cozinhe 5 min em fogo baixo.",
      "Finalize com cheiro-verde.",
    ],
    dica: "Marmita perfeita para 2 dias — R$ 5 por porção. Proteína magra + vegetais variados.",
    recomendado: ["diabetes", "colesterol", "esteatose", "hipertensao"],
    alertas: {},
    adaptacoes: {},
  },
  ...
  "Tapioca com ovo mexido": {
    tempo: "10 min", porcao: "1 tapioca",
    ingredientes: [
      "3 col. sopa goma de tapioca",
      "1 ovo",
      "Sal a gosto",
      "Cheiro-verde (opcional)",
    ],
    preparo: [
      "Peneire a goma de tapioca em frigideira antiaderente quente.",
      "Espalhe e deixe firmar 1 min de cada lado.",
      "Em outra frigideira, mexa o ovo com sal e cheiro-verde.",
      "Recheie a tapioca com o ovo mexido e dobre.",
    ],
    dica: "Lanche da tarde sem glúten por R$ 2,50. Saciedade alta com poucas calorias.",
    recomendado: ["celiaca"],
    alertas: {
      diabetes: "Tapioca tem alto índice glicêmico — limite a 3 col. sopa de goma e combine com proteína.",
    },
    adaptacoes: {
      diabetes: "Substitua a tapioca por crepioca (1 ovo + 1 col. sopa aveia + 1 col. sopa goma) — bem menos glicêmico.",
    },
  },

  "Polenta cremosa com frango": {
    tempo: "25 min", porcao: "1 prato",
    ingredientes: [
      "4 col. sopa fubá",
      "120g peito de frango desfiado",
      "1 tomate picado",
      "1/2 cebola",
      "Alho e cheiro-verde",
      "1 col. chá azeite",
    ...
    preparo: [
      "Refogue cebola e alho em pouco azeite.",
      "Adicione frango temperado e tomate, cozinhe 8 min.",
      "Em outra panela, dissolva fubá em 1 xíc. água fria.",
      "Cozinhe a polenta em fogo baixo, mexendo, por 10 min até engrossar.",
      "Sirva a polenta com o frango por cima.",
    ],
    dica: "Receita italiana adaptada ao bolso brasileiro — R$ 4 por prato. Fubá é fonte de carboidrato barato e nutritivo.",
    recomendado: ["anemia"],
    alertas: {
      celiaca: "O fubá puro é sem glúten, mas confira se não tem contaminação cruzada.",
    },
    adaptacoes: {},
  },

  "Salada de feijão verde com tomate": {
    tempo: "15 min", porcao: "2 porções",
    ingredientes: [
      "1 xíc. feijão verde cozido (ou feijão fradinho)",
      "1 tomate picado",
    ...
    preparo: [
      "Cozinhe o feijão até ficar al dente (não muito mole).",
      "Misture com tomate, cebola e ervas frescas.",
      "Tempere com azeite, limão e pouco sal.",
      "Deixe descansar 10 min antes de servir.",
    ],
    dica: "Saladinha refrescante e barata. Proteína vegetal + fibras + zero gordura saturada — ótima para esteatose.",
    recomendado: ["esteatose", "colesterol", "diabetes"],
    alertas: {
      gota: "Feijão verde tem purinas moderadas — consuma em pequenas porções.",
    },
    adaptacoes: {},
  },

  "Bife de panela com batata": {
    tempo: "30 min", porcao: "2 porções",
    ingredientes: [
      "200g patinho em bifes finos",
      "2 batatas em cubos",
    ...
    preparo: [
      ...
      "Doure rapidamente em pouco azeite (2 min cada lado).",
      "Adicione cebola, batata e cenoura.",
      "Cubra com 1 xíc. de água quente e tampe.",
      "Cozinhe 20 min em fogo baixo até a batata ficar macia.",
    ],
    dica: "Almoço de domingo de bairro — R$ 7 por porção. Patinho é a carne magra mais barata do mercado.",
    recomendado: ["anemia"],
    alertas: {
      gota: "Carne vermelha tem purinas — limite e prefira frango.",
      colesterol: "Use cortes bem magros (patinho, coxão mole) e tire toda gordura visível.",
    },
    adaptacoes: {
      colesterol: "Substitua o patinho por peito de frango — mesmo preparo, menos gordura.",
    },
  },

  "Banana assada com canela": {
    tempo: "15 min", porcao: "1 sobremesa",
    ingredientes: [
      "1 banana madura",
      "1 col. chá canela em pó",
      "1 col. chá aveia em flocos (opcional)",
    ],
    preparo: [
      "Corte a banana ao meio no comprimento.",
      "Coloque em forma untada com pouco azeite ou em refratário antiaderente.",
      "Polvilhe canela por cima.",
      "Asse a 180°C por 10 min até dourar.",
      "Polvilhe aveia se quiser textura crocante.",
    ],
    dica: "Sobremesa por R$ 1, sem açúcar adicionado. A banana já é doce e a canela ajuda no controle glicêmico.",
    recomendado: ["diabetes", "colesterol", "esteatose"],
    alertas: {},
    adaptacoes: {},
  },
  ...
  "Arroz integral com legumes": {
    ...
    ingredientes: [
      ...
      "1 cenoura em cubos",
      "1/2 xíc. ervilha (fresca ou congelada)",
      "1/2 cebola",
    ...
    preparo: [
      "Refogue cebola e alho em pouco azeite.",
      "Adicione o arroz integral e refogue 1 min.",
      "Acrescente 2 1/4 xíc. de água quente, sal e os legumes.",
      "Cozinhe em fogo baixo, tampado, por 25 min.",
      "Solte com garfo e finalize com cheiro-verde.",
    ],
    dica: "Refeição completa em uma panela só — R$ 3 por porção. Fibras do arroz integral são essenciais para esteatose.",
    recomendado: ["esteatose", "colesterol", "diabetes", "hipertensao"],
    alertas: {},
    adaptacoes: {},
  },
  ...
  "Sanduíche natural caseiro": {
    tempo: "10 min", porcao: "1 sanduíche",
    ingredientes: [
      "2 fatias de pão integral",
      "1 ovo cozido amassado",
      "1 col. sopa cenoura ralada",
      "1 folha de alface",
      "1 col. chá iogurte natural (substitui maionese)",
      "Sal e pimenta",
    ],
    preparo: [
      "Cozinhe o ovo (10 min) e amasse com garfo.",
      "Misture com cenoura ralada, iogurte, sal e pimenta.",
      "Monte o sanduíche: pão, alface, recheio, pão.",
    ],
    dica: "Lanche de bolso por R$ 2,50 — substitui pão de queijo de padaria. Iogurte no lugar de maionese baixa muito a gordura.",
    recomendado: ["esteatose", "colesterol", "diabetes"],
    alertas: {
      celiaca: "Use pão sem glúten.",
      lactose: "Use iogurte sem lactose.",
  ...
  "Sopa de feijão com legumes": {
    tempo: "30 min", porcao: "2 tigelas",
    ingredientes: [
      "1 xíc. feijão carioca cozido (com caldo)",
    ...
    preparo: [
      "Refogue cebola e alho em pouco azeite.",
      "Adicione batata e cenoura, refogue 2 min.",
      "Acrescente o feijão com seu caldo + 1 xíc. de água.",
      "Cozinhe 15 min até a batata ficar macia.",
      "Adicione a couve nos últimos 3 min.",
      "Finalize com cheiro-verde.",
    ],
    dica: "R$ 3 por tigela substanciosa. Combina ferro do feijão com vitamina C da couve = absorção ótima para anemia.",
    recomendado: ["anemia", "esteatose", "colesterol"],
    alertas: {
      gota: "Feijão tem purinas — modere se tiver crise.",
    },
    adaptacoes: {},
  },
  ...
  "Frango com quiabo e angu": {
    tempo: "35 min", porcao: "2 porções",
    ingredientes: [
      "200g sobrecoxa de frango sem pele",
    ...
    preparo: [
      "Tempere o frango com alho e sal.",
      "Refogue o quiabo com limão (tira a baba) por 8 min.",
      "Em outra panela, doure o frango.",
      "Junte tudo e cozinhe mais 15 min com 1/2 xíc. água.",
      "Faça o angu: dissolva fubá em 1 xíc. água fria, cozinhe mexendo até engrossar.",
      "Sirva o frango com angu cremoso.",
    ],
    dica: "Prato típico mineiro adaptado — R$ 6 por porção. Quiabo ajuda no controle de glicemia e colesterol.",
    recomendado: ["diabetes", "colesterol", "anemia"],
    alertas: {
      celiaca: "Use fubá certificado sem glúten.",
    },
    adaptacoes: {},
  },

  "Salada brasileira simples": {
    tempo: "10 min", porcao: "1 prato",
    ingredientes: [
    ...
    preparo: [
      ...
      "Corte tudo e monte no prato.",
      "Tempere com azeite, limão e pouco sal.",
    ],
    dica: "Acompanhamento de R$ 2,50 que vai bem com qualquer prato. Quanto mais vegetal no prato, melhor para esteatose e diabetes.",
    recomendado: ["esteatose", "colesterol", "diabetes", "hipertensao"],
    alertas: {},
    adaptacoes: {},
  },
  ...
  "Mingau de aveia simples": {
    tempo: "8 min", porcao: "1 tigela",
    ingredientes: [
      "1/2 xíc. aveia em flocos",
      "1 xíc. leite (ou bebida vegetal)",
      "1 banana fatiada",
      "Canela em pó",
    ],
    preparo: [
      "Aqueça o leite em panela.",
      "Adicione a aveia e cozinhe 3 min, mexendo, até engrossar.",
      "Despeje na tigela e cubra com banana e canela.",
    ],
    dica: "Café da manhã quentinho por R$ 2. A aveia controla colesterol e a banana adoça naturalmente — sem precisar açúcar.",
    recomendado: ["colesterol", "esteatose", "diabetes"],
    alertas: {
      celiaca: "Use aveia certificada sem glúten.",
      lactose: "Use bebida vegetal.",
  ...
  "Lentilha refogada simples": {
    ...
    preparo: [
      "Cozinhe a lentilha em 3 xíc. água com louro por 20 min até ficar macia.",
      "Refogue cebola e alho em pouco azeite.",
      "Adicione a lentilha cozida, tempere com sal e cheiro-verde.",
      "Cozinhe mais 5 min para apurar o sabor.",
    ],
    dica: "Substitui carne em refeição vegetariana por R$ 2 a porção. Ferro vegetal — ótima opção para anemia (combine com limão para absorver melhor).",
    recomendado: ["anemia", "esteatose", "colesterol", "diabetes"],
    alertas: {
      gota: "Lentilha tem purinas — modere se tiver crise.",
    },
    adaptacoes: {},
  ...
  "Quibe assado de aveia": {
    tempo: "40 min", porcao: "4 porções",
    ingredientes: [
      "200g carne moída magra (patinho)",
      "1 xíc. aveia em flocos",
      "1/2 cebola ralada",
      "1 dente de alho amassado",
      "Hortelã picada (ou salsinha)",
      "Suco de 1 limão",
      "Sal e pimenta",
    ],
    preparo: [
      "Hidrate a aveia em 1 xíc. de água por 10 min.",
      "Misture todos os ingredientes em uma tigela até virar massa firme.",
      "Espalhe em forma untada com pouco azeite, marque em quadrados.",
      "Asse a 200°C por 30 min até dourar.",
    ],
    dica: "Quibe sem trigo, mais leve e barato — R$ 4 por porção. Aveia substitui o trigo bem.",
    recomendado: ["colesterol", "esteatose"],
    alertas: {
      gota: "Carne moída — limite a porção.",
      celiaca: "Use aveia certificada sem glúten.",
    },
    adaptacoes: {},
  },

  "Pão de queijo de tapioca (sem leite)": {
    tempo: "25 min", porcao: "8 unidades",
    ingredientes: [
      "1 xíc. goma de tapioca",
      "2 ovos",
      "1/2 xíc. água",
      "1/4 xíc. queijo minas ralado",
      "1 pitada de sal",
    ],
    preparo: [
      "Misture todos os ingredientes em uma tigela até virar massa.",
      "Faça bolinhas com mãos úmidas.",
      "Coloque em forma untada com pouco azeite.",
      "Asse a 200°C por 20 min até dourar.",
    ],
    dica: "Versão sem leite e sem trigo — R$ 1 por unidade. Naturalmente sem glúten e bem mais leve que o pão de queijo tradicional.",
    recomendado: ["celiaca"],
    alertas: {
      lactose: "Substitua o queijo minas por queijo sem lactose.",
      diabetes: "Tapioca tem alto índice glicêmico — coma 2-3 unidades, não mais.",
    },
    adaptacoes: {
      lactose: "Use queijo sem lactose ou tofu temperado picado bem fininho.",
    },
  },

  "Couve refogada com alho": {
    tempo: "10 min", porcao: "2 porções",
    ingredientes: [
    ...
    preparo: [
      "Lave a couve, retire o talo e corte em tiras finas.",
      "Aqueça frigideira com pouco azeite e alho fatiado.",
      "Adicione a couve e refogue rapidamente (3 min) — não pode murchar muito.",
      "Tempere com pouco sal.",
    ],
    dica: "Acompanhamento de R$ 2 super nutritivo. Couve é uma das verduras mais ricas em ferro e cálcio — combine com limão para absorver melhor.",
    recomendado: ["anemia", "esteatose", "colesterol", "hipertensao"],
    alertas: {
      tireoide: "Couve em excesso pode interferir na tireoide — modere se tiver hipotireoidismo.",
    },
    adaptacoes: {},
  },
  ...
  "Sopa de abóbora com gengibre": {
    tempo: "30 min", porcao: "2 tigelas",
    ingredientes: [
      "300g abóbora cabotiá em cubos",
      "1/2 cebola",
      "2 dentes de alho",
      "1 col. chá gengibre ralado",
      "1 col. chá azeite",
      "Sal e cheiro-verde",
    ],
    preparo: [
      "Refogue cebola, alho e gengibre em pouco azeite.",
      "Adicione a abóbora e cubra com 500ml de água.",
      "Cozinhe 20 min até ficar bem macia.",
      "Bata no liquidificador até ficar cremosa.",
      "Volte à panela, ajuste sal e finalize com cheiro-verde.",
    ],
    dica: "Sopa de R$ 3 anti-inflamatória. O gengibre ajuda na esteatose e a abóbora é doce naturalmente, sem precisar açúcar.",
    recomendado: ["esteatose", "colesterol", "diabetes", "hipertensao"],
    alertas: {
      gastrite: "Vá leve no gengibre se tiver gastrite ativa.",
    },
    adaptacoes: {},
  },
  ...
  "Strogonoff de frango light": {
    tempo: "20 min", porcao: "2 porções",
    ingredientes: [
      "200g peito de frango em tiras",
      "1/2 xíc. iogurte natural",
      "1 col. sopa molho de tomate caseiro",
      "1/2 cebola",
      "1 dente de alho",
    ...
    preparo: [
      ...
      "Refogue cebola em pouco azeite, adicione o frango e doure.",
      "Acrescente o molho de tomate, cozinhe 5 min.",
      "Desligue o fogo, espere 1 min e misture o iogurte (não pode ferver).",
      "Finalize com cheiro-verde.",
    ],
    dica: "Strogonoff light por R$ 5 a porção — usa iogurte no lugar de creme de leite. Sirva com arroz integral e batata-doce assada.",
    recomendado: ["colesterol", "esteatose", "diabetes"],
    alertas: {
      lactose: "Use iogurte sem lactose.",
    },
    adaptacoes: {
      lactose: "Iogurte sem lactose ou creme vegetal de aveia funcionam igual.",
    },
  },
};
